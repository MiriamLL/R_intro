...
background-image: url(https://images.unsplash.com/photo-1495461199391-8c39ab674295?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80)
background-size: cover
...
```{r echo=FALSE, out.height=350}
knitr::include_graphics(paste0(ImageFolder,"201longer.png?raw=true"))
```
...
```{r echo=FALSE, out.height=350}
knitr::include_graphics(paste0(ImageFolder,"201wider.png?raw=true"))
```
...
name: out
class: title-slide
background-image: url(https://images.unsplash.com/photo-1586969593928-1c87c1f9c2ef?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1173&q=80)
background-size: cover
