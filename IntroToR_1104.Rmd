...
- Questions can be made [`r fa("external-link-alt", fill = "#f2cc8f")` at this link too]( https://docs.google.com/document/d/1uG7a2_hkdaKQm5gKXRBFf6gcyoUBan2e69gL3ZKcwg8/edit?usp=sharing)
...
To install R and Rstudio you can visit the page [`r fa("external-link-alt", fill = "#f2cc8f")` posit](https://posit.co/download/rstudio-desktop/)
...
If you opt to update R, one way to do it is going to the [installation page](https://www.r-project.org/)
