...
- Questions can be made [here]( https://docs.google.com/document/d/1uG7a2_hkdaKQm5gKXRBFf6gcyoUBan2e69gL3ZKcwg8/edit?usp=sharing)
...
knitr::include_graphics(paste0(ImageFolder,"Clase01_02UpdateR.png?raw=true"))
```
