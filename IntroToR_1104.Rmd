...
Some examples of webpage that provide data to practice are:[TidyTuesday](https://github.com/rfordatascience/tidytuesday)  
...
name: packages
class: title-slide, inverse, bottom
background-image: url(https://images.unsplash.com/photo-1617123623686-2b7b339785da?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1173&q=80)
background-size: cover
...
Another analogy is that install.packages() is downloading an app, and library() is like opening the app every time you want to use it.
...
name: read-files
class: title-slide, inverse, bottom
background-image: url(https://images.unsplash.com/photo-1668852222395-11d9154ade25?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=686&q=80)
background-size: cover
...
Instead of clicks, we can do write in the console or script:
...
(Showing just for illustration purposes)
...
There are many other options of files, let me know if you want to see an example [here `r fa("external-link-alt", fill = "#f2cc8f")`]( https://docs.google.com/document/d/1uG7a2_hkdaKQm5gKXRBFf6gcyoUBan2e69gL3ZKcwg8/edit?usp=sharing)
