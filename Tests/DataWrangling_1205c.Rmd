...
### `r text_spec("Getting the ingredients", background = "#003049", color = "#e5e5e5", bold = T)`
]
...
-  I also want to make some cakes 🎂 and I need 200 g of sugar. How many grams of sugar for 5 cakes?
...
###  `r text_spec("Organize your recipe book", background = "#003049", color = "#e5e5e5", bold = T)`
]
...
##  `r text_spec("Overview of your ingredients", background = "#003049", color = "#e5e5e5", bold = T)`
]
...
###  `r text_spec("Prepare your ingredients", background = "#003049", color = "#e5e5e5", bold = T)`
]
...
###  `r text_spec("Mixing", background = "#003049", color = "#e5e5e5", bold = T)`
]
...
###  `r text_spec("Storing", background = "#003049", color = "#e5e5e5", bold = T)`
]
