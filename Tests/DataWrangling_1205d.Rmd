...
### `r text_spec("Ingredients", background = "#003049", color = "#e5e5e5", bold = T)`
]
...
name: out
class:inverse
background-image: url(https://images.unsplash.com/photo-1447078806655-40579c2520d6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80)
background-size: cover
