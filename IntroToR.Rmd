...
There you will find two links, start with installing R

Depending on your computer, you need to select the one that fits you better
...
If you already had R and want to see if you need to update you can use:
...
When you want to update R in R studio, it most likely will suggest that you use your R console
...
Your R console must be on your installed programs
...
If you already had R packages installed in your previous version, you might not want to install one by one again.
...
As to March 2023 this was the newest version of R.
...
If you alredy have Rstudi and want to see if you need to update you can go to:
...
R very often is trying to tell us how to solver the error.
