...
### `r text_spec("Try some different", background = "#003049", color = "#e5e5e5", bold = T)`
]
...
Download the shapefile from [Europe](https://github.com/MiriamLL/R_intro/blob/master/Downloads/Europe.shp)

Give the directory. 
Either by calling the package **here**.
...
Use the argument **st_read** to load your shapefile.
...
In our particular case, not using the correct projection might derive in calculation mistakes and differences between studies.
