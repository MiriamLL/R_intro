...
- [Palettes](https://mycolor.space/?hex=%23845EC2&sub=1)
- [Size, Shape, Lines](https://ggplot2.tidyverse.org/articles/ggplot2-specs.html)
- [Geocomputation with R](https://r.geocompx.org/attr.html)
- [Earth Data Science](https://www.earthdatascience.org/)
- [r-spatial](https://r-spatial.org/r/2018/10/25/ggplot2-sf-3.html)
...
.pull-right[
#  `r text_spec("Layers", background = "#003049", color = "#e5e5e5", bold = T)`
### `r text_spec("Adding geometries", background = "#003049", color = "#e5e5e5", bold = T)`
]
...
```{r,fig.width=6, fig.height=3, echo=TRUE, warning=FALSE,message=FALSE}
Base_map+ 
...
.pull-left[
```{r,fig.width=6, fig.height=4, echo=TRUE, warning=FALSE, message=FALSE}
Base_map+
  coord_sf(xlim = c(6.2,6.4), 
           ylim = c(55.1,55.2))+
  geom_point(data=survey_4326,
...
```{r echo=FALSE, out.height=200}
knitr::include_graphics("https://github.com/MiriamLL/R_intro/blob/master/Images/321Lines.png?raw=true")
```
]
